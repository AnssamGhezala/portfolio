...
- Autonomously built product features from requirements to discussions with the product manager and UX/UI designers.
...
- Maintained NodeJS API serving as a backend for ads visited by thousands of users daily. Implemented features for these ads using LiveScript, HTML, and CSS.
